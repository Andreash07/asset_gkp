...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2026 at 03:31 AM
...
CREATE TABLE `assets` (
  ...
  `kategori_atas_nama` varchar(20) DEFAULT NULL,
  `status_hak_milik` tinyint(1) DEFAULT NULL COMMENT 'HGB,SGU.HM,etc',
  `jenis_dokumen_kepemilikan` tinyint(4) DEFAULT NULL,
...
(2, 0, 'GKP Kampung Sawah', 'GKP Jemaat', 0, NULL, NULL, 'Jalan Raya Kampung Sawah no 177, Kec. Pondok Melati, Kel. Jatimurni', NULL, NULL, NULL, NULL, NULL, '120', 'Rumah Pastori 2', NULL, 1, 0, '0', 'Surat-surat lengkap', 'tidak ada', '-6.323228295318335', '106.93642855413613', '2026-07-04 04:30:47', NULL, NULL, NULL, 0, NULL),
(3, 0, 'GKP Kampung Sawah', 'GKP Jemaat', 0, NULL, NULL, 'Jalan Raya Kampung Sawah no 177, Kec. Pondok Melati, Kel. Jatimurni', NULL, NULL, NULL, NULL, NULL, '120', 'Rumah Pastori 2', NULL, 1, 0, '0', 'Surat-surat lengkap', 'tidak ada', '-6.323228295318335', '106.93642855413613', '2026-07-04 04:31:54', NULL, NULL, NULL, 0, NULL),
(4, 0, 'GKP', 'GKP', 0, NULL, NULL, 'Jl. Dewi Sartika no. 119\r\n(Sesuai Dokumen)', NULL, NULL, NULL, NULL, NULL, '1000', 'Kantor MS', NULL, 1, 0, '0', 'ini data Lokasi Sertifikat ', '', '-6.9319437919845655', '107.60644912719727', '2026-07-04 04:40:59', NULL, NULL, NULL, 0, NULL),
...
(2, 0, '101', 'UJI COBA KAMSAW', 'Jl. Awiligar No.55', 'Bandung', 'Indonesia', '-', '-', 'OK', 0, '2022-02-13 15:43:23', 'ADMIN', '2021-12-29', '2021-12-29', 1),
...
(25, 0, '302', 'GKP CIMUNING', 'Jl. Raya Bantar Gebang-Setu Rt 03/07 Mustikaya', 'Bekasi', 'Indonesia', '-', '-', NULL, 0, '2021-09-11 11:29:06', 'ADMIN', '2021-09-11', '2021-09-11', 4),
...
INSERT INTO `jenis_dokumen_kepemilikan` (`id`, `name`, `status`, `created_at`) VALUES
(0, 'Tidak Diketahui', 1, '2026-07-05 05:56:30'),
(1, 'Sertipikat', 1, '2026-07-05 04:14:16'),
(2, 'AJB', 1, '2026-07-05 04:14:16'),
(3, 'Girik/Letter C/Persil', 1, '2026-07-05 04:15:31'),
(4, 'Eigendom Verponding', 1, '2026-07-05 04:15:31'),
(5, 'Pinjam', 1, '2026-07-05 04:15:31'),
(6, 'Akta Hibah', 1, '2026-07-05 04:15:31');
...
INSERT INTO `jenis_hak_milik` (`id`, `name`, `status`, `created_at`) VALUES
(0, 'Tidak Diketahui', 1, '2026-07-05 05:55:17'),
(1, 'HM', 1, '2026-07-05 05:54:12'),
(2, 'HGB', 1, '2026-07-05 05:54:51'),
(3, 'HGU', 1, '2026-07-05 05:54:51'),
(4, 'HP', 1, '2026-07-05 05:54:51');
...
INSERT INTO `kategori_kepemilikan` (`id`, `name`, `status`, `created_at`) VALUES
(0, 'Tidak Diketahui', 1, '2026-07-05 05:55:57'),
(1, 'Sinode GKP', 1, '2026-07-05 05:29:23'),
(2, 'Jemaat GKP', 1, '2026-07-05 05:29:23'),
(3, 'Badan Pelayanan GKP', 1, '2026-07-05 05:32:15'),
(4, 'Mitra', 1, '2026-07-05 05:32:32'),
(5, 'Negara', 1, '2026-07-05 05:32:32'),
(7, 'Pribadi', 1, '2026-07-05 06:39:04');
